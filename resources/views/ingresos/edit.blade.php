...
<div class="card card-default">
   <div class="card-body d-flex justify-content-center row mt-3 pb-0">
      {!! Form::open(['method' => 'POST', 'class' => 'col-12 col-md-11 col-lg-12 font-sm', 'id' => 'form-ingreso']) !!}
      {!! Form::hidden('id_ingreso', $ingreso->id, []) !!}
      {!! Form::token() !!}

      @include('ingresos.form.eform')
...
@section('script')
<script src="{{ asset('scripts/script_ingresosE.js') }}"></script>
@endsection