   ...
   <div class="col-12 col-lg-9">
      <div class="row">
         ...
         <div class="col-12 col-sm-6 col-lg-6 mt-2 px-sm-2{{ $errors->has('rol_usu') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('rol_usu', ['' => 'SELECCIONAR...'] + $rol, null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'rol']) !!}
         ...
         <div class="col-12 col-sm-6 col-lg-6 mt-2 px-sm-2{{ $errors->has('username') ? ' has-error' : ''}}">
            ...
            {!! Form::text('username', null, ['class' => 'form-control alfanumerico' , 'placeholder' => 'Codigo de Usuario', 'autocomplete' => 'off', 'id' => 'username']) !!}
         ...
         <div class="col-12  mt-2 px-sm-2{{ $errors->has('nom_usu') ? ' has-error' : ''}}">
            ...
            {!! Form::text('nom_usu', null, ['class' => 'form-control alfanumerico' , 'placeholder' => 'Nombre de Usuario', 'autocomplete' => 'off', 'id' => 'nom_usuario']) !!}
         ...
         <div class="col-12 col-sm-8 col-lg-8 mt-2 px-sm-2">
            ...
            <div class="input-group{{ $errors->has('email_usu') ? ' has-error' : ''}}">
               {!! Form::text('email_usu', null, ['class' => 'form-control', 'placeholder' => 'ejemplo@email.com', 'autocomplete' => 'off', 'id' => 'email_usuario']) !!}
         ...
         <div class="col-12 col-sm-4 col-lg-4 mt-2 px-sm-2{{ $errors->has('est_usu') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('est_usu', ['1' => 'ACTIVO', '0' => 'INACTIVO'], '1', ['class' => 'form-control', 'placeholder'=> 'SELECCIONAR...', 'id' => 'est_usuario']) !!}
                  ...
                  <div class="form-group row">
                     <div class="col-12 col-sm-6 col-lg-6">
                        ...
                        <div class="input-group{{ $errors->has('pass_usu') ? ' has-error' : ''}}">
                           {!! Form::password('pass_usu', ['class' => 'form-control' , 'placeholder' => 'Contraseña', 'onpaste' => 'return false', 'autocomplete' => 'off', 'id' => 'password_usu']) !!}
                           <div class="input-group-text">
                     ...
                     <div class="col-12 col-sm-6 col-lg-6 mt-2 mt-lg-0">
                        ...
                        <div class="input-group{{ $errors->has('repass_usu') ? ' has-error' : ''}}">
                           {!! Form::password('repass_usu', ['class' => 'form-control' , 'placeholder' => 'CONFIRMAR CONTRASEÑA', 'onpaste' => 'return false', 'autocomplete' => 'off', 'id' => 'repassword_usu']) !!}
                           <div class="input-group-text">
                              <i class="fas fa-key"></i>
                           </div>
                        </div>
