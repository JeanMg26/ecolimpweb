   ...
   <div class="tab-pane fade show active px-4" id="instalacion" role="instalacion" aria-labelledby="home-tab">
      <div class="row pt-4 pb-5">
         ...
         <div class="col-12 col-md-12 col-lg-12 col-xl-6 mt-2 {{ $errors->has('nom_proveedor') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::text('nom_proveedor', null, ['class' => 'form-control alfanumerico' , 'id' => 'nom_proveedor', 'autocomplete' => 'off', 'placeholder' => 'NOMBRE DEL PROVEEDOR', 'autofocus', 'maxlength' => '35']) !!}
         ...
         <div class="col-12 col-md-8 col-lg-8 col-xl-6 mt-2 {{ $errors->has('nom_fantasia') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::text('nom_fantasia', null, ['class' => 'form-control alfanumerico' , 'id' => 'nom_fantasia', 'autocomplete' => 'off', 'placeholder' => 'NOMBRE DE FANTASIA', 'maxlength' => '35']) !!}
         ...
         <div class="col-12 col-md-4 col-lg-4 col-xl-3 mt-2{{ $errors->has('nrodoc_proveedor') ? ' has-error-select2' : ''}}">
            ...
            <div class="input-group">
               {!! Form::text('nrodoc_proveedor', null, ['class' => 'form-control numeros2' , 'id' => 'nrodoc_proveedor', 'autocomplete' => 'off', 'placeholder' => 'NÚMERO DE RUN', 'maxlength' => '12']) !!}
         ...
         <div class="col-12 col-md-4 col-lg-4 col-xl-3 mt-2{{ $errors->has('tel_proveedor') ? ' has-error-select2' : ''}}">
            ...
            <div class="input-group {{ $errors->has('cel_instalacion') ? ' has-error-select2' : ''}}">
               {!! Form::text('tel_proveedor', null, ['class' => 'form-control numeros', 'id' => 'tel_proveedor', 'autocomplete' => 'off', 'placeholder' => 'TELÉFONO', 'maxlength' => '9']) !!}
               <div class="input-group-text">
