                  ...
                  <div class="card card-border">
                     ...
                     <div class="card-body">
                        <div class="col-12 col-lg-11 row mt-3 mt-md-0">
                           ...
                           {!! Form::label('region', 'REGIÓN - PROVINCIA - COMUNA:', ['class' => 'col-12 col-md-5 font-weight-bold mb-0']) !!}
                           <div class="col-12 col-md-7 ">
                              <p class="mb-2" id="lregion"></p>
                           </div>

                           {!! Form::label('direccion', 'DIRECCIÓN:', ['class' => 'col-12 col-md-5 font-weight-bold mb-0']) !!}
                           <div class="col-12 col-md-7 ">
                           ...
                           {!! Form::label('telefono', 'TELÉFONO:', ['class' => 'col-12 col-md-5 font-weight-bold mb-0']) !!}
                           <div class="col-12 col-md-7 ">
