...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item"><a href="{{ route('empleados.index') }}"><span><i class="fad fa-user-tie mr-2"></i></span>Personal</a></li>
...
<div class="card card-default">
   <div class="card-body d-flex justify-content-center row my-3">
      {!! Form::open(['route' => 'empleados.store', 'method' => 'POST' , 'class' => 'col-12 col-md-11 col-xl-11 font-sm', 'files' => true, 'id' => 'form-empleado']) !!}
      {!! Form::token() !!}
   ...
   <div class="card-footer text-center">
      {!! Form::button('<i class="fas fa-save mr-2"></i>Guardar', ['class'=>'btn btn-success mr-1', 'id' => 'btn-usumodal']) !!}
      {{-- {!! Form::button('<i class="fas fa-save mr-2"></i>Guardar', ['class'=>'btn btn-success mr-1', 'type' => 'submit']) !!} --}}
