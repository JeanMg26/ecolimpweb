   ...
   <div class="col-12 col-lg-9">
      <div class="row">
         <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2{{ $errors->has('tipodoc_emp') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('tipodoc_emp', ['CARNET DE EXTRANJERIA' => 'CARNET DE EXTRANJERIA', 'RUN' => 'RUN'], isset($empleado) ? $empleado->tipodoc : '', ['class' => 'form-control', 'placeholder'=> 'SELECCIONAR...', 'id' => 'tipodoc_emp', 'autofocus']) !!}
         ...
         <div class="col-12 col-sm-6 col-md- col-lg-4 mt-2">
            ...
            <div class="input-group{{ $errors->has('nrodoc_emp') ? ' has-error' : ''}}">
               {!! Form::text('nrodoc_emp', isset($empleado) ? $empleado->nrodoc : '', ['class' => 'form-control numeros2', 'placeholder' => 'NÚMERO RUN', 'maxlength' => '14', 'autocomplete' => 'off', 'id' => 'nrodoc_emp']) !!}
         ...
         <div class="col-12 col-sm-6 col-md- col-lg-4 mt-2">
            ...
            <div class="input-group{{ $errors->has('fec_nac') ? ' has-error' : ''}}">
               {!! Form::text('fec_nac', isset($empleado) ? date('d-m-Y', strtotime($empleado->fec_nac)) : '', ['class' => 'form-control', 'placeholder' => 'DD-MM-YYYY', 'maxlength' => '10', 'autocomplete' => 'off', 'readonly', 'id' => 'fec_nac']) !!}
               <div class="input-group-text">
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-6 mt-2{{ $errors->has('nom_emp') ? ' has-error' : ''}}">
            ...
            {!! Form::text('nom_emp', isset($empleado) ? $empleado->nombres : '', ['class' => 'form-control letras' , 'placeholder' => 'NOMBRES', 'autocomplete' => 'off', 'maxlength' => '40', 'id' => 'nom_emp']) !!}
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-6 mt-2{{ $errors->has('ape_emp') ? ' has-error' : ''}}">
            ...
            {!! Form::text('ape_emp', isset($empleado) ? $empleado->apellidos : '', ['class' => 'form-control letras', 'id' => 'ape_emp', 'placeholder' => 'APELLIDOS', 'autocomplete' => 'off','maxlength' => '40', 'id' => 'ape_emp']) !!}
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-8 mt-2">
            ...
            <div class="input-group{{ $errors->has('email_emp') ? ' has-error' : ''}}">
               {!! Form::text('email_emp', isset($empleado) ? $empleado->email : '', ['class' => 'form-control', 'placeholder' => 'EJEMPLO@ABC.COM', 'autocomplete' => 'off', 'maxlength' => '40', 'id' => 'email_emp']) !!}
               <div class="input-group-text">
                  <i class="fas fa-at"></i>
               </div>
            </div>
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2{{ $errors->has('gen_emp') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('gen_emp', ['M' => 'MASCULINO', 'F' => 'FEMENINO'], isset($empleado) ? $empleado->genero : '', ['class' => 'form-control form-control-sm', 'placeholder'=> 'SELECCIONAR...', 'id' => 'gen_emp']) !!}
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2{{ $errors->has('cargo_emp') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('cargo_emp', ['' => ''] + $rol, $usuarioRol, ['class' => 'form-control', 'id' => 'cargo_emp']) !!}
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2">
            ...
            <div class="input-group{{ $errors->has('cel_emp') ? ' has-error' : ''}}">
               {!! Form::text('cel_emp', isset($empleado) ? $empleado->celular : '', ['class' => 'form-control numeros', 'placeholder' => '999999999', 'maxlength' => '9', 'autocomplete' => 'off', 'id' => 'cel_emp']) !!}
               <div class="input-group-text">
         ...
         <div class="col-12 col-sm-6 col-md-6 col-lg-4 mt-2{{ $errors->has('est_emp') ? ' has-error-select2' : ''}}">
            ...
            {!! Form::select('est_emp', ['1' => 'ACTIVO', '0' => 'INACTIVO'], isset($empleado) ? $empleado->estado : '', ['class' => 'form-control', 'placeholder'=> 'SELECCIONAR...', 'id' => 'est_emp']) !!}
