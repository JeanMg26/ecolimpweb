...
<ol class="breadcrumb">
   ...
   <li class="breadcrumb-item">
      <a href="{{ route('instalaciones.index') }}"><span><i class="fad fa-store-alt mr-2"></i></span>Centro de Costos</a>
   </li>
...
<div class="card card-default">
   <div class="card-body d-flex justify-content-center row my-3">
      {!! Form::model($instalacion, ['route' => ['instalaciones.update', $instalacion->id], 'method' => 'PUT', 'class' => 'col-12 col-md-11 col-xl-10', 'files' => true, 'id' => 'form-instalacion']) !!}
      {!! Form::token() !!}

      @include('instalaciones.form.eform')
   ...
   <div class="card-footer text-center">
      ...
      {!! Form::button('<i class="far fa-sync-alt mr-2"></i>Actualizar', ['class'=>'btn btn-light-blue mr-1', 'type'=>'submit', 'name' => 'submit', 'value' => 'Aceptar', 'id' => 'btn-action']) !!}
...
@section('script')
<script src="{{ asset('scripts/script_instalacionesE.js') }}"></script>
@endsection