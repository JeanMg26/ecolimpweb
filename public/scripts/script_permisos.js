$(function () {
   ...
   function init() {
      ...
      var collapsedGroups = {};
      let table = $("#tabla_permisos").DataTable({
         serverSide: true,
         pageLength: 50,
         processing: true,
         orderFixed: {
         ...
         rowGroup: {
            ...
            startRender: function (rows, group) {
               ...
               return $("<tr/>")
                  .append(
                     '<td colspan="1"><button type="button" class="btn-collapse"><i class="far fa-plus"></i></button></td>'
                  )
                  .append(
            ...
            success: function (data) {
               if (data.errors) {
                  ...
                  if (data.errors.nom_permiso_hidden) {
                     ...
                     $("#nom_permiso-error").html(
                        data.errors.nom_permiso_hidden[0]
                     );
                  }
      ...
      $(document).on("click", ".edit", function () {
         ...
         $.ajax({
            ...
            success: function (data) {
               ...
               $(".action_button").addClass("btn-light-blue");
               $(".action").val("Editar");
               $("#modalPermiso").modal("show");
            },
         });
