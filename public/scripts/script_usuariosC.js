$(function () {
   ...
   function validations() {
      ...
      const mensajes = {
         ...
         'username': {
            required: 'Codigo de usuario.',
            minlength: 'Ingresar como mínimo de 8 caracacteres',
            maxlength: 'Ingresar como máximo 8 caracacteres.'
         },
         'rol_usu': {
   ...
   function alerts() {
      ...
      $('#username').on('keyup', function () {
         if ($(this).val().length) {
            ...
            if ($(this).next().next('#username-error').length) {
