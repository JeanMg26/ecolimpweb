...
class ProveedorERequest extends FormRequest
{
   ...
   {
      return [
         'nom_proveedor'    => 'required|min:6|max:50|unique:proveedores,nombre,' . $this->proveedore . ',id,deleted_at,NULL',
         'nom_fantasia'     => 'required|min:6|max:50',
         'nrodoc_proveedor' => 'required|min:12|max:12|unique:proveedores,nrodoc,' . $this->proveedore . ',id,deleted_at,NULL',
         'email_proveedor'  => 'required|email|max:50|unique:proveedores,email,' . $this->proveedore . ',id,deleted_at,NULL',
