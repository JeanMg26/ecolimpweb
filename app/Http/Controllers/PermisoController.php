      ...
      return DataTables::of($permiso)
         ->addColumn('acciones', function ($permiso) {
            ...
            if (Auth::user()->can('PERMISO-LISTAR')) {
               $mostrar =
               '<button class="btn btn-warning btn-accion text-white mr-1 view" id="' . $permiso->id . '" data-toggle="tooltip" data-placement="top" title="Ver">
            <span class="fal fa-eye fa-xs"></span>
            </button>';
            }
            if (Auth::user()->can('PERMISO-EDITAR')) {
               $mostrar .=
               '<button class="btn btn-info btn-accion edit mr-1" id="' . $permiso->id . '" data-toggle="tooltip" data-placement="top" title="Editar">
            <span class="far fa-edit fa-xs"></span>
            </button>';
            }
            if (Auth::user()->can('PERMISO-ELIMINAR')) {
               $mostrar .=
               '<button class="btn btn-danger btn-accion delete mr-1" id="' . $permiso->id . '" data-toggle="tooltip" data-placement="top" title="Eliminar">
